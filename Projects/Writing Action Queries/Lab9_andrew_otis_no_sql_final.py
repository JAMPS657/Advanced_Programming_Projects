...
#%% Part1,Q2) pid, state, and name of the children for people who have 7 
#             children
...
#%% Part1,Q4-graded) All info of people who live in CA and have 6 or 7 
#                    children
...
#%% Part1,Q5-graded) Using $regex. List the pid and children names for all  
#                     people who have a child whose name contains 'Bob A'
...
#%% Part2,Q2 Write an example of an update for the collection you used in 
...
#%% Part2,Q3 Write an example of a delete command for the collection that 
